...
public class Ex02_Arrays {
	public static void main(String[] args) {
		//Arrays 클래스는 배열의 복사, 항목의 정렬, 항목 검색
		//배열을 다루기 위한 다양한 메서드를 제공한다
		//Arrays 클래스를 이용하면 배열의 기능을 더욱 쉽게 사용할수 있다.
		...
		Integer[] iArrIntegers = {1,6,2,3,10,7,4,5,8,9};
		
		Arrays.sort(iArrIntegers,Comparator.reverseOrder());
		System.out.println(Arrays.toString(iArrIntegers));
		...
		//깊은 복사(Deep Copy) : 복사된 배열이나 원본 배열이
		...
		//다차원 배열
		//2차원 이상의 배열을 의미하며, 비열의 요소로 또 다른 배열을 가지는것을 의미한다.
